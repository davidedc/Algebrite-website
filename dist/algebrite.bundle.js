...
(function() {
  ...
  mini_solve = function() {
    var BIGC, BIGC_over_3a, BIGC_simplified_toCheckIfZero, C_CHECKED_AS_NOT_ZERO, ROOTS_DELTA0, ROOTS_DELTA0_toBeCheckedIfZero, ROOTS_DELTA1, ROOTS_Q, ROOTS_determinant, a_b_c, a_b_c_d_18, a_c, bcubed, bsq_csq, bsquared, ccubed, csquared, flipSignOFQSoCIsNotZero, four_ROOTS_DELTA0_pow3, i_sqrt3, minus4_a_ccubed, minus4_bcubed_d, minus_b_over_3a, minus_nine_abc, minus_twentyseven_asquare_dsquare, n, one_minus_i_sqrt3, one_plus_i_sqrt3, root_solution, six_a, six_a_BIGC, three_a, three_a_BIGC, three_ac, twentyseven_asquare_d, two_bcubed;
    n = 0;
    save();
    p2 = pop();
    p1 = pop();
