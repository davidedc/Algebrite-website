...
(function() {
  ...
  run = function(stringToBeRun, generateLatex) {
    var allReturnedLatexStrings, allReturnedPlainStrings, cacheKey, collectedLatexResult, collectedPlainResult, currentStateHash, error, error1, error2, frozen, i, indexOfPartRemainingToBeParsed, n, possiblyCached, stringToBeReturned, theErrorMessage, timeStart, timingDebugWrite, toBeFrozen, totalTime;
  ...
  computeResultsAndJavaScriptFromAlgebra = function(codeFromAlgebraBlock) {
    var ae, code, i, latexResult, len, readableSummaryOfCode, ref2, result, testableStringIsIgnoredHere, timeStartFromAlgebra, userSimplificationsInProgramForm;
